...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=12):
        ...
        self.layer4 = self._make_layer(block, 80, num_blocks[3], stride=2)
        #self.linear0 = nn.Linear(3072, 800)
        #self.bn2 = nn.BatchNorm1d(800)
        self.linear = nn.Linear(1920, num_classes)
    ...
    def forward(self, x):
        ...
        out = self.layer1(out)
        #out = F.dropout2d(out, training=self.training,p=0.2)
        out = self.layer2(out)
        #out = F.dropout2d(out, training=self.training,p=0.2)
        out = self.layer3(out)
        #out = F.dropout2d(out, training=self.training,p=0.2)
        ...
        #out = F.relu(self.bn2(self.linear0(out)))
